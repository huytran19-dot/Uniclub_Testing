...
echo ========================================
echo Running Login Tests with Chrome Visible + Allure Report
echo Feature: User Authentication (Login)
echo ========================================
echo.
...
REM ==============================
REM STEP 3: Run Login Tests with Chrome Visible
REM ==============================
echo.
echo [3/4] Running Login Tests - Watch Chrome window!
echo ========================================
echo 👁️  You can see each test step in Chrome browser
echo 🔐 Testing: Login, Logout, Validation
...
if %TEST_EXIT_CODE% EQU 0 (
    ...
    echo ========================================
    echo   - All login test steps executed successfully

...
echo ========================================
echo Running Registration Tests with Chrome Visible + Allure Report
...
REM ==============================
REM STEP 3: Run Registration Tests with Chrome Visible
REM ==============================
echo.
echo [3/4] Running Registration Tests - Watch Chrome window!
echo ========================================
echo 👁️  You can see each test step in Chrome browser
echo 📝 Testing: User Registration, Validation, OTP
...
if %TEST_EXIT_CODE% EQU 0 (
    ...
    echo ========================================
    echo   - All registration test steps executed successfully

...
echo ========================================
echo Running Tests with Chrome Visible + Allure Report
echo You can watch the test execution live!
echo ========================================
echo.
...
REM ==============================
REM STEP 3: Run Tests with Chrome Visible
REM ==============================
echo.
echo [3/4] Running tests - Watch Chrome window!
echo ========================================
...
if %TEST_EXIT_CODE% EQU 0 (
    ...
    echo ✅ TESTS PASSED!
    echo ========================================
    echo   - All test steps executed successfully
